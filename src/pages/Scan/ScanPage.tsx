          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-6 shadow-xs">
              ...
              <ul className="text-xs text-slate-500 dark:text-slate-400 space-y-1.5 list-disc list-inside">
                <li>Automatic rear-camera selection on smartphones and tablets.</li>
                <li>Real-time frame evaluation running up to 30 frames per second.</li>
                <li>Camera stream tracks terminate immediately when stopped.</li>
              </ul>
            </div>
            ...
            <div className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-6 shadow-xs">
              ...
              <ul className="text-xs text-slate-500 dark:text-slate-400 space-y-1.5 list-disc list-inside">
                <li>Ideal for screenshots, digital flyers, and photos sent via email.</li>
                <li>Automatic canvas downsampling prevents browser memory exhaustion.</li>
                <li>Decoded immediately without uploading the file to remote servers.</li>
              </ul>
            </div>
          </div>
